...
// If already logged in, skip straight to the homepage
...
<head>
	...
	<title>FruzzHub Sample 1a (Seller's View)</title>
		...
		<div class="login_form">
			<form action="register.php" method="post">
				...
				<div class="remember-row">
					<a href="sample1b.php">Forgot Password?</a>
				</div>

				<button type="submit" name="signIn">Log In</button>
				<p>Don't have an account? <a href="sample2a.php">Register Shop Here</a></p>
			</form>
		</div>
	</div>
</body>
